...
st.title("💖 Detector de Cariño")

st.write("Esto es importante… respondé con sinceridad 😌")
...
if st.button("Descubrir resultado ❤️"):
    if nombre and altura:
        ...
        st.write(f"Por ende, {nombre} mide {altura*100:.0f} cm de pura ternura ✨")
        
        st.balloons()
    else:
        st.warning("Tenés que completar todo 😄")